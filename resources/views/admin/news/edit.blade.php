...
<div class="page-header no-margin-bottom">
    <div class="container-fluid">
        <h2 class="h5 no-margin-bottom"> Edit News</h2>
    </div>
</div>
<!-- Breadcrumb-->
<div class="container-fluid">
            ...
            <div class="col-sm-11">
                <form class="form-horizontal" action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="title" placeholder="Enter the title" class="form-control" value="{{ $news->title }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="author" placeholder="Name of the author" class="form-control" value="{{ $news->author }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <select name="category_id" class="form-control mb-0">
                                ...
                                <option value="{{ $c->id }}" @if($c->id == $news->category_id)
                                    selected
                                    @endif
                                    >{{ $c->title }}</option>
                                @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <textarea rows="5" name="description" placeholder="Enter the description" class="form-control">
                            {{ $news->description }}
                            </textarea>
                        </div>
                    </div>
